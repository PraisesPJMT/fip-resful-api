...
> This repository shows my week 03 deliverables for the Flexisaf Internship Program (FIP) - Advanced Frontend Development track. The learning outcomes is to learn API methods and how to make API calls.
...
```sh
  git clone git@github.com:PraisesPJMT/fip-resful-api
  cd fip-resful-api
```
